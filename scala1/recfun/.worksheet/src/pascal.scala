object pascal {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(181); 
  ...
  pascal(4, 4);System.out.println("""res14: Int = """ + $show(res$14));$skip(17); val res$15 = 
  
  pascal(0,2);System.out.println("""res15: Int = """ + $show(res$15));$skip(14); val res$16 = 
  pascal(1,2);System.out.println("""res16: Int = """ + $show(res$16));$skip(14); val res$17 = 
  pascal(1,3);System.out.println("""res17: Int = """ + $show(res$17))}
}
